...
//! }
//!
//! impl hal::nonblocking::serial::Read<u8> for Serial<USART1> {
//!     type Error = Error;
//!
...
//! }
//!
//! impl hal::nonblocking::serial::Write<u8> for Serial<USART1> {
//!     type Error = Error;
//!
...
//! use embedded_hal::nonblocking::serial::Write;
//! use nb::block;
//!
//! # fn main() {
...
//! where
//!     S: hal::nonblocking::serial::Write<u8>
//! {
//!     for &byte in buffer {
...
//! where
//!     T: hal::nonblocking::timer::CountDown<Error = ()>,
//!     S: hal::nonblocking::serial::Read<u8>,
//! {
...
//! where
//!     S: hal::nonblocking::serial::Write<u8, Error = Infallible>,
//! {
//!     loop {
...
//! # }
//! # struct Serial1;
//! # impl hal::nonblocking::serial::Write<u8> for Serial1 {
