...
>  A Hardware Abstraction Layer (HAL) for driving a Universal Asynchronous
>  Receiver/Transmitter (UART) peripheral on embedded systems
...
[API reference]: https://docs.rs/embedded-hal-serial

## How-to: add a new trait

This is the suggested approach to adding a new trait to `embedded-hal-serial`
